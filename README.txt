...
3. !WHISPER - when a user types this keyword, he has the ablitiy to send messages to a specific user without the message being broadcasted to the rest of the chatroom.
